...
public class IteratingMaps {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Integer> map = new LinkedHashMap<>();  //random order, does not accept null key, synchronized
        ...
        for (Map.Entry<String, Integer> eachEntry : map.entrySet()) {
            System.out.println(eachEntry);    // each entry is a pair, has both key and value
        }

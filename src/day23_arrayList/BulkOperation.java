...
public class BulkOperation {
    ...
    public static void main(String[] args) {
       ...
       // l1.addAll(Arrays.asList(nums));
        ...
        ArrayList<String> emplyeeList = new ArrayList<>();
        emplyeeList.addAll(Arrays.asList("Alena", "Muhtar", "Gadir", "Ali"));

        System.out.println(emplyeeList);

        boolean hasAlena = emplyeeList.contains("Alena");
        System.out.println("hasAlena = " + hasAlena);
        
        boolean hasAlenaGadir = emplyeeList.containsAll(Arrays.asList("Alena", "Gadir"));

        boolean hasMuhtarAliKuzzat = emplyeeList.containsAll(Arrays.asList("Muhtar", "Ali", "Kuzzat"));
